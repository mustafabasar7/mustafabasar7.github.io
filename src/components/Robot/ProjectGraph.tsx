...
const NODES_3D: Record<string, GNode3D[]> = {
  ...
  "tool-routing": [
    ...
    { x: 250, y: 170, r: 17, kind: "tool", glb: "/models/graph/translate.glb", scale: 0.85 },
    { x: 244, y: 240, r: 17, kind: "tool2", glb: "/models/graph/verify.glb", scale: 1.0 },
  ...
  swarm: [
    ...
    { x: 117, y: 306, r: 17, kind: "agent", glb: R(2) },
    { x: 183, y: 306, r: 17, kind: "agent", glb: R(3) },
    { x: 250, y: 306, r: 17, kind: "agent", glb: R(8) },
  ],
  "hitl-safety": [
    { x: 150, y: 40, r: 16, kind: "dot" },
